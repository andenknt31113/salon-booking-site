...
/* 単品メニュー：[区分, メニュー名, 価格, 所要(分), 説明]
   ...
   所要(分)は掲載にない目安です。★要確認 */
const LISTED_MENUS = [
  ['カット', 'ツーブロック、刈り上げ、フェードのメンテナンスカット', '4000〜', 40,
    '当店のご来店から３週以内の方のメンテナンスメニューになりますスキンフェードは＋500になります'],
  ['カット', 'カットコース', 7000, 70, ''],
  ['カット', 'ラグジュアリーカットコース', 10000, 110, ''],
  ['カット', '刈り上げ＋フェードメンテナンス', '4000〜', 40,
...
const LISTED_COUPONS = [
  ...
  ['【毎朝のセット1分】品よく決まるお悩み解決メンズパーマ', 14500, 120],
  ['【彩で見せるワンランク上のお洒落を】カット＋カラー', 14500, 120],
  ['【毎日をストレスフリーに】カット＋ベーシックストレートorアイパー', 19800, 150],
  ['【ブリーチメニューはこれ！】カット+デザインカラー', '', 180],
  ['【全ての施術が＋クオリティ】ダメージケアトリートメント', 3300, 40],
  ['【髪の膨らみ、立ち上がり１発解決】カット+ダウンパーマ、アップパーマ', 11000, 90],
  ['【メニューも相談したい方へ】当日一緒に考えましょう！', '', 30],
  ['第１印象確実UP！　眉毛WAX & 眉毛パーマ', 6600, 50],
  ['【髪のハリ.ツヤ.コシ全てのチャージ】髪質改善トリートメント', 7000, 60],
  ['ヘアセット ※シャンプーブロー込み', 4000, 40]
];
...
function メニューを掲載内容に入れ替える() {
  ...
  log.push('');
  log.push('・所要(分)は掲載にありません。置いてあるのは目安です。');
  log.push('  実際の時間に直してください（ここがずれると、次のお客様と重なります）。');
